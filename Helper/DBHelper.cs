...
namespace Helpers
{
    ...
    {
#if DEBUG
        private static string defaultConnectionString = "Data Source=localhost;Initial Catalog=pbsqlserver;Integrated Security=SSPI;User ID=JAYDEN FUNG;Password=F2u4n6g8@;";
#else
